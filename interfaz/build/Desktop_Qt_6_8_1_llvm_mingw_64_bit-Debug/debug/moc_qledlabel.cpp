...
namespace {
struct qt_meta_tag_ZN9QLedLabelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9QLedLabelE = QtMocHelpers::stringData(
    "QLedLabel",
    "setState",
    "",
    "State",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9QLedLabelE[] = {
...
Q_CONSTINIT const QMetaObject QLedLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9QLedLabelE.offsetsAndSizes,
    qt_meta_data_ZN9QLedLabelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9QLedLabelE_t,
        // Q_OBJECT / Q_GADGET
...
void *QLedLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9QLedLabelE.stringdata0))
